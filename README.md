...
- Other players wait and can see all melds. Players are allowed to place their cards on other players melds as long as they have completed the run melds themselves
- Round ends when a player has no cards remaining in their hand
- Scores calculated, andthe  next round begins
